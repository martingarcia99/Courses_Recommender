...
def get_avg_rating_page(path_to_pdf_file, lecture_name):
    pdf_pages = []
    pdf_dir = 'db/docs/pdf_page_gesamtbewertung'
    html_dir = 'db/docs/html_page_gesamtbewertung'
    ...
    for page in input.pages:
        pageNbr = input.getPageNumber(page)
...
def get_comments_page(path_to_pdf_file, lecture_name):
    pdf_dir = 'db/docs/pdf_page_comments'
    html_dir = 'db/docs/html_page_comments'
...
def create_html_file(pdf_page_path, title, lecture_name):
    html_file_path = 'db/docs/html_page_' + title + '/'+ lecture_name +'.html'
...
def get_avg_rating(file, semester):
    ...
    if(semester == 'ws19-20'):
        ...
        with open(file, 'r') as f:
            contents = f.read()
            soup = BeautifulSoup(contents, features="lxml")
            avg_rating = soup.select_one('body > div:nth-child(3) > span:nth-child(2)').get_text() if soup.select_one('body > div:nth-child(3) > span:nth-child(2)') else select_one('body > div:nth-child(21) > span:nth-child(2)').get_text() if soup.select_one('body > div:nth-child(21) > span:nth-child(2)') else soup.select_one('body > div:nth-child(22) > span:nth-child(2)').get_text() if soup.select_one('body > div:nth-child(22) > span:nth-child(2)') != None else soup.select_one('body > div:nth-child(24) > span:nth-child(2)').get_text() if soup.select_one('body > div:nth-child(24) > span:nth-child(2)') != None else soup.select_one('body > div:nth-child(25) > span:nth-child(2)').get_text() if soup.select_one('body > div:nth-child(25) > span:nth-child(2)') else soup.select_one('body > div:nth-child(26) > span:nth-child(2)').get_text() if soup.select_one('body > div:nth-child(26) > span:nth-child(2)') else soup.select_one('body > div:nth-child(28) > span:nth-child(3)').get_text() if soup.select_one('body > div:nth-child(28) > span:nth-child(3)') else soup.select_one('body > div:nth-child(29) > span:nth-child(2)').get_text() if soup.select_one('body > div:nth-child(29) > span:nth-child(2)') else ''
...
def get_lecture(semester, lecture, full_path_pdf, cleaned_lecture_name):
    ...
    if full_path_comments_html_page != None and semester == 'ws19-20':
        ...
        lecture_copie['avg_rating'] = avg_rating
        lecture_copie['semester'] = semester
        lecture_copie['positive_comments'] = positive_comments
        lecture_copie['negative_comments'] = negative_comments
        lecture_copie['lecture_id'] = lecture_id
        lecture_id+=1
...
with requests.Session() as sesh:
    ...
    for url in urls:
        ...
        full_path_pdf_ss19 = get_path('db/docs/ss2019', cleaned_lecture_name)
        semester = None
